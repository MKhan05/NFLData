...
side effects of the others. Hence, the most important variables are the ones expressed within model 7. Also noting, the actual formula takes 
into account attempts, number of completions, yards, touchdowns and interceptions. Our analysis did come very close by including attempts, 
completion percentage (completions divided by attempts), yards, touchdowns and interceptions and yards per pass (yards divided by attempts), 
